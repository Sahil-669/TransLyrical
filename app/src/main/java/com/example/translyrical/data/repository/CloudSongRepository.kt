...
interface CloudSongRepository {
    suspend fun uploadCloudSong(youtubeId: String?,title: String, artist: String, coverUrl: String?, syncedLyricsJson: String?, englishJson: String?, hindiJson: String?): Result<Unit>
